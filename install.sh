...
Labelled issues are handled by Sortie, running Claude Code for planning and design and
OpenCode for building and review. How that works, which labels drive it, and what this
project never lets an agent decide alone: [`config/sortie/README.md`](config/sortie/README.md).
POINTER
